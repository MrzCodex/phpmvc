...
<!-- Mirrored from themesdesign.in/morvin/layouts/auth-Register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Dec 2021 15:09:57 GMT -->
<head>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="px-2 py-3">
                                    ...
                                    <form class="form-horizontal mt-4 pt-2" action="<?=BASEURL;?>/auth/register_progress" method="post">
                        ...
                        <div class="mt-5 text-center text-white">
                            <p>You have an account ?<a href="<?=BASEURL;?>/auth" class="fw-bold text-white"> Log In</a> </p>
